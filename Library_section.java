...
public class Library_section {
	...
	public void removeMaterial(Library_material mat) {
		...
		if (list_of_books.contains(mat)) {
			...
			mat.availability = false;
		}
	}

	//declare a mat lost
	public void setLost(Library_material mat) {
		if(!mat.lost) {
			mat.lost= true;
			removeMaterial(mat);
		}
	...
	//declare a mat lost
	public void setDamaged(Library_material mat) {
		if(!mat.damaged) {
			mat.damaged= true;
			removeMaterial(mat);
		}
	...
	//declare a mat lost
	public void setFound(Library_material mat) {
		if(mat.lost) {
			mat.lost= false;
			addNewMaterial(mat);
		}
